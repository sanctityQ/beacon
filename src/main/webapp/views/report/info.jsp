    ...
    <div class="main" style="padding-bottom:60px">
        ...
        <div class="threshold_file">
            ...
            <ul class="remark">
                ...
                <li><b>最小值:</b> 它表示一小时之内所收集的最低值。例如，2004年9月1日14点显示的6就表示从2004年9月1日13点到14点之间收集的最低值为'6'.</li>
                <li><b>最大值:</b> 它表示一小时之内所收集的最高值。例如，2004年9月1日14点显示的12就表示从2004年9月1日13点到14点之间收集的最高值为'12'.</li>
                <li><b>每小时平均值:</b> 它表示一小时之内对所收集值取的平均值。例如，2004年9月1日14点显示的9就表示从2004年9月1日13点到14点之间收集值的平均值为'9'.</li>
            </ul>
        </div>
    </div>
</div>
