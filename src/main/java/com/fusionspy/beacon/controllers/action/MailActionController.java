package com.fusionspy.beacon.controllers.action;
...
import com.fusionspy.beacon.action.domain.MailActionService;
...
public class MailActionController {
	...
	@Autowired
	void setMailActionService(MailActionService mailActionService) {
