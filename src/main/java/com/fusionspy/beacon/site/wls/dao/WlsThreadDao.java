...
public interface WlsThreadDao extends PagingAndSortingRepository<WlsThread, Integer> {
    ...
    public List<Statistics> statisticIdleCount(String resourceId, String start, String end);
    ...
    public List<Statistics> statisticThought(String resourceId, String start, String end);
}
